...
\begin{tabular}{lrrrr}
\toprule
 & {EPO} & {PPP} & {Proposed (hist.)} & {Proposed (ex post)} \\
\midrule
\multicolumn{5}{l}{\textit{Panel A: Mean return}} \\
Difference & -3.73 & -0.72 & 18.68$^{***}$ & 22.86$^{***}$ \\
$t$-statistic & -1.48 & -0.40 & 2.73 & 3.19 \\
Bootstrap $p$-value & [0.162] & [0.688] & [0.004] & [0.000] \\
\addlinespace
\multicolumn{5}{l}{\textit{Panel B: Sharpe ratio}} \\
Difference & -0.14 & -0.10 & 0.30 & 0.45 \\
$t$-statistic & -0.90 & -1.04 & 1.16 & 1.64 \\
Bootstrap $p$-value & [0.381] & [0.306] & [0.269] & [0.111] \\
\addlinespace
\multicolumn{5}{l}{\textit{Panel C: CRRA certainty equivalent}} \\
Difference & -1.38 & -3.29 & 2.74 & 8.71 \\
$t$-statistic & -0.53 & -1.27 & 0.36 & 1.05 \\
Bootstrap $p$-value & [0.601] & [0.261] & [0.723] & [0.304] \\
\bottomrule
\end{tabular}
